...
import { BlueLine, FormCost, FormGroup , ButtonOk , LinkItem } from "./styled-index";
    ...
    <>
      <Form>
        {isCost ? (
            ...
            <LinkItem>
              <button type="button" style={{marginTop: "20px" , display:"flex" , marginLeft:"auto"}} onClick={handleOpen}>
                {t("Header.8")}
                <i class="bx bx-right-arrow-circle"></i>
              </button>
            </LinkItem>
            <BlueLine>
              {count ?<h3>{count} {t("HomeCost.11")}</h3>: null}
            </BlueLine>
          </div>
